...
|----------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| path       | The path to the USB port where the Serial port RS485 adapter is connected to your machine. <u>For example</u>: */dev/serial/by-id/usb-1a86_USB_Serial-if00-port0* or */dev/ttyUSB0* if the port is unique. You can find the path to use in the Settings-System-Hardware-All Hardware menu, under ttyUSB. see the photo below. **Leave blank when using a TCP gateway** — enable `use_gateway` and set `gateway_ip_port` instead. If both `jkbms_path` is blank and `use_gateway` is disabled, the add-on will fail to start with an error message in the add-on log.                                                                                                                                                                                                                                                                     |
